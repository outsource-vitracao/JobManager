    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                        <a class="btn dark btn-outline btn-circle btn-sm" href="{{route('get-job')}}" > Nhận Job</a>
                    </div>
                </div>
            </div>
            @if(isset($jobs))
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    <a href="{{route('editor-job-detail',$job->id)}}" class="btn btn-outline btn-circle dark btn-sm black">Xem chi tiết</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
